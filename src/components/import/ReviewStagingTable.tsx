      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-700">
        <div className="flex items-center gap-4 text-xs font-semibold">
          <div className="text-slate-700 dark:text-slate-300">
            Total Parsed: <span className="font-bold text-slate-900 dark:text-white">{stagedList.length}</span>
          </div>
        ...
        {duplicateCount > 0 && (
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-rose-50 dark:bg-rose-950/50 hover:bg-rose-100 text-rose-700 dark:text-rose-300 text-xs font-bold transition-colors"
          >
              ...
              return (
                <tr
                  ...
                  className={`hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors ${
                    row.isDuplicate ? 'bg-amber-50/30 dark:bg-amber-950/10' : ''
                  }`}
                >
                  {/* Checkbox */}
                  ...
                  <td className="py-3 px-3 whitespace-nowrap">
                    <input
                      ...
                      className="py-1 px-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs"
                    />
                  </td>
                  ...
                  <td className="py-3 px-3 min-w-[200px]">
                    <div className="space-y-1">
                      <input
                        ...
                        className="w-full py-1 px-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs font-semibold text-slate-900 dark:text-white"
                      />
                      {row.isDuplicate && (
                  ...
                  <td className="py-3 px-3 whitespace-nowrap">
                    <select
                      ...
                      className="py-1 px-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs font-medium"
                    >
                      {categories.map(c => (
                  ...
                  <td className="py-3 px-3 text-right whitespace-nowrap">
                    <input
                      ...
                      className="w-24 py-1 px-2 text-right font-bold bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white"
                    />
                  </td>
