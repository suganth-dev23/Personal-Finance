  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-[#131822] text-slate-900 dark:text-white p-6 sm:p-8 border border-slate-200/90 dark:border-[#202836] shadow-sm">
        ...
        {/* Quick Micro-stats */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-5 border-t border-slate-200/80 dark:border-[#202836]">
          <div className="bg-slate-50 dark:bg-[#171E2A] border border-slate-200/80 dark:border-[#202836] rounded-2xl p-3">
            ...
            <p className="text-sm sm:text-base font-extrabold text-slate-900 dark:text-white mt-0.5 font-numeric">{categories.length} types</p>
          </div>
          <div className="bg-slate-50 dark:bg-[#171E2A] border border-slate-200/80 dark:border-[#202836] rounded-2xl p-3">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Custom User</span>
            <p className="text-sm sm:text-base font-extrabold text-emerald-600 dark:text-emerald-400 mt-0.5 font-numeric">{customCount} custom</p>
          </div>
          <div className="bg-slate-50 dark:bg-[#171E2A] border border-slate-200/80 dark:border-[#202836] rounded-2xl p-3">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Active Spends</span>
            <p className="text-sm sm:text-base font-extrabold text-teal-600 dark:text-teal-400 mt-0.5 font-numeric">{categorySpendingThisMonth.length} categories</p>
          </div>
          <div className="bg-slate-50 dark:bg-[#171E2A] border border-slate-200/80 dark:border-[#202836] rounded-2xl p-3">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Top Spend</span>
            <p className="text-sm sm:text-base font-extrabold text-rose-600 dark:text-rose-400 mt-0.5 truncate">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {categories.map(cat => {
          ...
          return (
            <div
              key={cat.id}
              className="group bg-white dark:bg-[#131822] rounded-3xl p-5 border border-slate-200/90 dark:border-[#202836] hover:border-emerald-500/40 transition-all duration-300 shadow-sm hover:shadow-md flex flex-col justify-between"
            >
              <div>
