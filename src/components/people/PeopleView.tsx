                  ...
                  {filteredSettledContacts.map(contact => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => setSplitModalContact(contact)}
                          className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-amber-500/10 text-amber-700 dark:text-[#F5B742] hover:bg-amber-500/20 text-xs font-bold transition-all border border-amber-500/20 active:scale-95"
